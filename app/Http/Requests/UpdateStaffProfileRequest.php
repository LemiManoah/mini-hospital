...
class UpdateStaffProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => 'nullable|email|max:255|unique:staff_profiles,email,' . $this->route('id'),
            'staff_number' => 'required|string|max:50|unique:staff_profiles,staff_number,' . $this->route('id'),
