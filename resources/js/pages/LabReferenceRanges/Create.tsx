...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'New Reference Range', href: '#' },
];

export default function LabReferenceRangeCreate({ parameters, parameterId }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        lab_result_parameter_id: parameterId || '',
        age_range_from: '',
        age_range_to: '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/lab-reference-ranges', submitData);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="New Lab Reference Range" />
            <div className="mt-4 mb-4 flex items-center justify-between gap-2 px-4">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-2xl font-bold">New Lab Reference Range</h1>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Saving...' : 'Save Reference Range'}
                        </Button>
                    </div>
                </form>
            </div>
