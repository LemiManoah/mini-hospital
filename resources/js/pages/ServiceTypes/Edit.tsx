...
import { index as indexRoute } from '@/routes/service-types';
...
export default function ServiceTypeEdit({ serviceType }: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mt-4 mb-4 flex items-center justify-between gap-2 px-4">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-2xl font-bold">Edit Service Type: {serviceType.name}</h1>
                </div>
            </div>
