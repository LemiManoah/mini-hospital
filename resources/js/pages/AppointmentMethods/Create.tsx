...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create Method', href: '#' },
];

export default function AppointmentMethodCreate() {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        post('/appointment-methods');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Appointment Method" />
            <div className="mt-4 mb-4 flex items-center gap-2 px-4">
                ...
                <h1 className="text-2xl font-bold">Create Appointment Method</h1>
            </div>
