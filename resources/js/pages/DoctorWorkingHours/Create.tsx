...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Add Working Hours', href: '#' },
];

export default function DoctorWorkingHourCreate({
    doctors = [],
    days = [],
}: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mt-4 mb-4 flex items-center gap-2 px-4">
                ...
                <h1 className="text-2xl font-bold">Add Working Hours</h1>
            </div>
