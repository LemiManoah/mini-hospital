...
export default function AppointmentCategoryEdit({ category }: Props) {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        put(`/appointment-categories/${category.id}`);
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mt-4 mb-4 flex items-center gap-2 px-4">
                ...
                <h1 className="text-2xl font-bold">Edit Appointment Category</h1>
            </div>
