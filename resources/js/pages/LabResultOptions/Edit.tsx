...
export default function LabResultOptionEdit({ labResultOption, services }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        lab_test_id: labResultOption.lab_test_id.toString(),
        option_value: labResultOption.option_value,
        label: labResultOption.label,
        is_abnormal: labResultOption.is_abnormal,
        sort_order: labResultOption.sort_order,
    });
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Lab Result Option: ${labResultOption.label}`} />
